...
impl EmbodiedField {
    ...
    /// phase, centre couplings, nadi state or EarthBody amplitude that K8 did not
    /// itself determine.
...
impl M4DomainState {
    ...
    pub fn from_personal_state(
        ...
        if input.transformation.subject_id != personal.subject_id {
...
impl TransformationPhase {
    /// Advance the historical 12 x 3 / 24-stroke coordinate as an odometer.
...
mod tests {
    ...
    #[test]
    fn personal_receiver_continues_into_seven_centres_without_invented_phase() {
